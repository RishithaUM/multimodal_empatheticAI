const features = [
  ...
  },
  {
    ...
    description: 'Monitor live emotion states with instant feedback, confidence scores, and a dynamic detection timeline.',
    color: '#00D4AA',
    wide: false,
  },
  {
    icon: 'ri-brain-line',
    title: 'AI Explainable Results',
    description: 'Understand exactly how the AI reached its conclusion with per-modality breakdowns and fusion explanations.',
    color: '#EC4899',
    wide: false,
  },
  {
    ...
    description: 'Download detailed PDF reports of each session with full analysis, insights, and recommendations.',
    color: '#F59E0B',
    wide: false,
  },
  {
    ...
    description: 'Browse and search your complete emotion analysis history with filtering and export capabilities.',
    color: '#3B82F6',
    wide: false,
  },
  {
    ...
    description: 'Automatically notify trusted contacts when repeated distress patterns or high-intensity negative emotions are detected.',
    color: '#EF4444',
    wide: false,
  },
];
